    ...
    <section id="about-scene" class="py-24 md:py-36 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto w-full select-none relative z-20">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
        ...
        <div class="lg:col-span-6 flex flex-col justify-end pt-4 lg:pt-32">
          ...
          <div class="about-biography space-y-8 font-sans text-base md:text-lg text-[#9A9A9A] leading-[1.8] max-w-xl font-normal relative z-10">
          ...
          <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-8 border-l border-[#1E1E1E] pl-6 py-2 about-meta font-mono text-[10px] md:text-[11px] text-[#9A9A9A] tracking-[0.15em] uppercase">
            <div class="space-y-3">
              <div><span class="text-[#39FF14] font-semibold block mb-0.5">INSTITUTION //</span> Anand Institute of Higher Tech</div>
              <div><span class="text-[#39FF14] font-semibold block mb-0.5">TIMELINE //</span> 2024 &mdash; 2028</div>
              <div><span class="text-[#39FF14] font-semibold block mb-0.5">ACADEMICS //</span> CGPA: 8.96 / 10</div>
            </div>
            <div class="space-y-3">
              <div class="text-[#39FF14] font-semibold mb-1.5">CURRENTLY EXPLORING //</div>
              <ul class="space-y-2 list-none">
                <li class="flex items-center gap-2"><span class="w-1 h-1 bg-[#39FF14]"></span> Python</li>
                <li class="flex items-center gap-2"><span class="w-1 h-1 bg-[#39FF14]"></span> Full-Stack Dev</li>
                <li class="flex items-center gap-2"><span class="w-1 h-1 bg-[#39FF14]"></span> AI / Data Science</li>
                <li class="flex items-center gap-2"><span class="w-1 h-1 bg-[#39FF14]"></span> Software Eng</li>
                <li class="flex items-center gap-2"><span class="w-1 h-1 bg-[#39FF14]"></span> DSA</li>
              </ul>
            </div>
          </div>
        </div>
