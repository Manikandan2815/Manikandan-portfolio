 ...
 */
import { renderLoading, startLoadingAnimation } from './components/loading.js?v=18';
import { renderNavigation, setupNavigationInteractions } from './components/navigation.js?v=18';
import { renderHero, animateHeroEntrance } from './components/hero.js?v=18';
import { renderAbout } from './components/about.js?v=18';
import { renderSkills } from './components/skills.js?v=18';
import { renderProjects } from './components/projects.js?v=18';
import { renderJourney } from './components/journey.js?v=18';
import { renderCertifications } from './components/certifications.js?v=18';
import { renderContact, setupContactInteractions } from './components/contact.js?v=18';

import { initSmoothScroll } from './utils/smooth-scroll.js?v=18';
import { initGlobalAnimations } from './utils/animations.js?v=18';
import { initWebGL } from './components/webgl.js?v=18';
import { initCursor } from './utils/cursor.js?v=18';
import { initMagnetics } from './utils/magnetic.js?v=18';
