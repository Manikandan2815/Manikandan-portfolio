 ...
 */
import { renderLoading, startLoadingAnimation } from './components/loading.js?v=19';
import { renderNavigation, setupNavigationInteractions } from './components/navigation.js?v=19';
import { renderHero, animateHeroEntrance } from './components/hero.js?v=19';
import { renderAbout } from './components/about.js?v=19';
import { renderSkills } from './components/skills.js?v=19';
import { renderProjects } from './components/projects.js?v=19';
import { renderJourney } from './components/journey.js?v=19';
import { renderCertifications } from './components/certifications.js?v=19';
import { renderContact, setupContactInteractions } from './components/contact.js?v=19';

import { initSmoothScroll } from './utils/smooth-scroll.js?v=19';
import { initGlobalAnimations } from './utils/animations.js?v=19';
import { initWebGL } from './components/webgl.js?v=19';
import { initCursor } from './utils/cursor.js?v=19';
import { initMagnetics } from './utils/magnetic.js?v=19';
