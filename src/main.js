 ...
 */
import { renderLoading, startLoadingAnimation } from './components/loading.js?v=20';
import { renderNavigation, setupNavigationInteractions } from './components/navigation.js?v=20';
import { renderHero, animateHeroEntrance } from './components/hero.js?v=20';
import { renderAbout } from './components/about.js?v=20';
import { renderSkills } from './components/skills.js?v=20';
import { renderProjects } from './components/projects.js?v=20';
import { renderJourney } from './components/journey.js?v=20';
import { renderCertifications } from './components/certifications.js?v=20';
import { renderContact, setupContactInteractions } from './components/contact.js?v=20';

import { initSmoothScroll } from './utils/smooth-scroll.js?v=20';
import { initGlobalAnimations } from './utils/animations.js?v=20';
import { initWebGL } from './components/webgl.js?v=20';
import { initCursor } from './utils/cursor.js?v=20';
import { initMagnetics } from './utils/magnetic.js?v=20';
